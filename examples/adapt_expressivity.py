...
def build_h4(spacing: float = 1.0):
    """Linear H4 Hamiltonian in the RHF molecular-orbital basis (8 qubits)."""
    ...
    return integrals.molecular_hamiltonian(mo_basis=True, n_electrons=4)
