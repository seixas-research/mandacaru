...
``carcara-oncvpsp`` and ``carcara-paw`` -- as flat directories of
...
or, from Python::
    ...
    from carcara.pseudopotentials.link_library import link_library
    link_library("paw", "~/Repositories/carcara-paw")
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m carcara.pseudopotentials.link_library",
        description="Link the external ONCVPSP / PAW (and optionally NCPP) "
                    "pseudopotential repositories into Carcará's library.")
