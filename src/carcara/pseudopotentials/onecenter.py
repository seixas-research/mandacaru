...
(:meth:`~carcara.pseudopotentials.paw.PAWIntegrals.two_body_augmentation`);
this module supplies the second.

It is **quadratic** in the one-centre density matrix :math:`D`, and that is the
point.  Carcará previously linearized it about the isolated atom -- a fixed
...
:mod:`carcara.pseudopotentials.multipoles`.
"""
...
def one_centre_coulomb(dataset, projectors, basis: str = "raw") -> np.ndarray:
    ...
    ``projectors`` are this atom's :class:`~carcara.pseudopotentials.orbitals.KBProjector`
