...
only ever see the spec: :func:`carcara.algorithms._hamiltonian_from_atoms.resolve_basis`
...
def lookup_family(name) -> FamilySpec | None:
    ...
    :func:`~carcara.algorithms._hamiltonian_from_atoms.resolve_basis` tells a
