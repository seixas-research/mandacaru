...
"""Hydrogenic Atomic Orbitals (HAO): analytic single-particle atomic orbitals.

:class:`HydrogenicAtomicOrbital` is the *single source of truth* for the analytic
atomic wavefunction in Mandacaru (an eigenfunction of a screened Coulomb, i.e.
...
class HydrogenicAtomicOrbital(BasisFunction):
    ...
    def from_slater(cls, n: int, l: int, m: int, atomic_number: int,
                    center=None, units: str = "angstrom") -> "HydrogenicAtomicOrbital":
    ...
    def __repr__(self) -> str:
        return (f"HydrogenicAtomicOrbital(n={self.n}, l={self.l}, m={self.m}, "
