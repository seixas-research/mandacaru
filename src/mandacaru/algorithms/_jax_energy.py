...
grid-sampled orbital derivatives, see :mod:`mandacaru.algorithms.forces`), the
...
The function mirrors :class:`~mandacaru.core.hamiltonian.MolecularIntegrals`
...
def _freeze_core(jnp, h_mo, eri_mo, frozen, active):
    ...
    Mirrors :func:`mandacaru.core.hamiltonian.freeze_core_integrals`.
    """
    if not frozen:
