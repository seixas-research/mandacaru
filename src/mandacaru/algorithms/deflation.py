...
ansatz (a fixed ansatz for :class:`~mandacaru.algorithms.vqe.VQE`, a freshly grown
one for :class:`~mandacaru.algorithms.adapt_vqe.ADAPTVQE`).  The exact state-vector
...
class EnergyLevels:
    ...
    :class:`~mandacaru.algorithms.vqe.VQEResult` /
    :class:`~mandacaru.algorithms.adapt_vqe.ADAPTVQEResult`; :meth:`in_units`
    converts either way.
    """
...
class DeflationMixin:
    ...
    :class:`~mandacaru.algorithms.base.VariationalDriver`).
    """
