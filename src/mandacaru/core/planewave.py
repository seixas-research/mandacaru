...
class PlaneWaveIntegrals:
    ...
    def nuclear_repulsion(self) -> float:
        ...
        divergences no longer cancel.  :func:`~mandacaru.core.ewald.ewald_energy`
    ...
    def molecular_nuclear_repulsion(self) -> float:
        ...
        Kept for comparison with the molecular (:class:`~mandacaru.core.hamiltonian.MolecularIntegrals`)
    ...
    def molecular_hamiltonian(self, include_nuclear_repulsion: bool = True,
        ...
        Mirrors :meth:`mandacaru.core.MolecularIntegrals.molecular_hamiltonian`:
