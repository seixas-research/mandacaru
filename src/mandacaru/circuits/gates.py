...
:class:`~mandacaru.core.mapping.Fermion` operators; a mapping (e.g. Jordan-Wigner)
turns each into a qubit :class:`~mandacaru.core.mapping.PauliSum`, and the ansatz
(:mod:`mandacaru.circuits.ansatz`) exponentiates them.
"""
